...
from API import p2p_fig, user_names, textp2p_transfig, P2P_fig_text, fig_bar_text, textp2p_transfigH5 #fig_bar
...
def create_layout(app):
            ...
            html.Div(
                [
                    ...
                    html.Div(
                        [
                            html.Div(
                                [html.H5(["Introduction to Austria"],style = {"color":"rgb(69,157,175)"}), 
                                  html.P("Austria is......"),
                                  html.Br([])
    ...
    value=0
                        ...
                        className="row ",
                        style={"margin-left": "0%", "margin-right":"0%", "margin-top":"1%", "zIndex":"7"}
                    ),
                                  html.Br([]),
                                  html.Br([]),
                                  html.Div(
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.Graph(id="transaustria",config = {'displayModeBar': False,
    'editable': False,
    'showLink':False,
                                ...
                                [
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.Graph(id="baraustria",config = {'displayModeBar': False,
    'editable': False,
    'showLink':False,
    'displaylogo': False}, figure={}, 
                                ...
                                [
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.Graph(id="p2ptransaustria",config = {'displayModeBar': False,
    'editable': False,
    'showLink':False,
    'displaylogo': False}, figure={}, 
