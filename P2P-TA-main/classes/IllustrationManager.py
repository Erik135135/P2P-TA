...
class Illustration(object):
    ...
    def draw_demand_user_with_P2P(self, df_bids, df_trans, user_names, timesteps):
        ...
        for i in user_names:
            ...
            fig = go.Figure([go.Scatter(x=df_p2p_user['time'], y=df_p2p_user['quantitybids'], name='Net load, user: ' + i)])
            fig.add_scatter(x=df_p2p_user['time'], y=df_p2p_user['quantityP2P'], name='Net load P2P, user: ' + i)
